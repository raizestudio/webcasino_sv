...
class City(models.Model):
    ...
    primary = models.ForeignKey(
        AdministrativeLevelPrimary, on_delete=models.CASCADE, related_name="cities", null=True, blank=True
    )
    secondary = models.ForeignKey(
        AdministrativeLevelSecondary, on_delete=models.CASCADE, related_name="cities", null=True, blank=True
    )
